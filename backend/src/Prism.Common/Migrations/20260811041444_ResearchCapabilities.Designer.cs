...
namespace Prism.Common.Migrations
{
    ...
    [Migration("20260811041444_ResearchCapabilities")]
    partial class ResearchCapabilities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prism.Common.Jobs.DurableJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Prism.Features.Datasets.Domain.DatasetRecord", b =>
                {
                    ...
                    b.Property<string>("AnnotationNote")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.HasIndex("DatasetId", "AnnotationLabel");

                    b.HasIndex("DatasetId", "IsCorrect");
            ...
            modelBuilder.Entity("Prism.Features.Evaluation.Domain.EvaluationEntity", b =>
                {
                    ...
                    b.Property<string>("ScoreDefinitions")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Prism.Features.Rag.Domain.RagQuerySet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("rag_query_sets", (string)null);
                });

            modelBuilder.Entity("Prism.Features.Rag.Domain.RagQuerySetItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<List<Guid>>("RelevantChunkIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
                    ...
                    b.HasIndex("QuerySetId");

                    b.ToTable("rag_query_set_items", (string)null);
                });

            modelBuilder.Entity("Prism.Features.Rag.Domain.RagTrace", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AssembledContext")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Prism.Features.Rag.Domain.RagQuerySetItem", b =>
                {
                    b.HasOne("Prism.Features.Rag.Domain.RagQuerySet", null)
                        .WithMany("Items")
                        .HasForeignKey("QuerySetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
